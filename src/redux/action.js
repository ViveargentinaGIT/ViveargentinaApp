...
export function sendRequestCancelation(saleId, userId) {
  ...
  return async function () {
    let response = await axios.get(
      `https://experienceviveargentina.onrender.com/sales/cancel?userId=${userId}&saleId=${saleId}`
    );
...
export function getSalesByUser(userId) {
  ...
  return async function (dispatch) {
    let salesByUser = await axios.get(
      `https://experienceviveargentina.onrender.com/sales/${userId}`
    );
    return dispatch({
...
export function updateSaleStatus(newStatus) {
  return async function () {
    let response = await axios.put(
      "https://experienceviveargentina.onrender.com/sales",
      newStatus
    );
...
export function approveSaleStatus(token, newStatus) {
  return async function () {
    ...
    let response = await axios.put(
      "https://experienceviveargentina.onrender.com/sales/approved",
      newStatus,
      { headers }
    );
  ...
  return async function () {
    try {
      let response = await axios.post(
        `https://experienceviveargentina.onrender.com/sales?userId=${userId}`,
        arrayItems
      );
      return response.data;
    } catch (e) {
...
export function addNewCart(userId, arrayItems) {
  return async function () {
    try {
      let response = await axios.post(
        `https://experienceviveargentina.onrender.com/cart?userId=${userId}`,
        arrayItems
      );
...
export function getCartByUser(userId) {
  return async function (dispatch) {
    let cartByUser = await axios.get(
      `https://experienceviveargentina.onrender.com/cart/${userId}`
    );
    return dispatch({
...
export function deleteReview(reviewId) {
  return async function () {
    let response = await axios.delete(
      `https://experienceviveargentina.onrender.com/reviews/${reviewId}`
    );
...
export function getAllUsers() {
  return async function (dispatch) {
    let allUsers = await axios.get(
      `https://experienceviveargentina.onrender.com/users`
    );
    return dispatch({
      type: GET_ALL_USERS,
...
export function getAllReviews() {
  return async function (dispatch) {
    let allReviews = await axios.get(
      `https://experienceviveargentina.onrender.com/reviews`
    );
    return dispatch({
...
export function getUserById(userId) {
  return async function (dispatch) {
    let userById = await axios.get(
      `https://experienceviveargentina.onrender.com/users/${userId}`
    );
    return dispatch({
      type: GET_USER_BY_ID,
...
export function buyInMercadoPago(saleId, itemsFromStore) {
  return async function (dispatch) {
    let response = await axios.post(
      `https://experienceviveargentina.onrender.com/mercadopago?saleId=${saleId}`,
      itemsFromStore
    );
    return dispatch({
...
export function verifyUser(token) {
  return async function () {
    fetch(`https://experienceviveargentina.onrender.com/users/verify/`, {
      method: "POST",
      headers: {
        Accept: "application/json",
        "Content-Type": "application/json",
...
export function passwordReset({ token, password }) {
  return async function () {
    ...
    const response = await axios.post(
      "https://experienceviveargentina.onrender.com/users/password_reset/",
      { password },
      { headers }
    );
    return response.data;
...
export function resetPasswordRequest(email) {
  return async function () {
    const response = await axios.post(
      "https://experienceviveargentina.onrender.com/users/reset_password_request",
      { email }
    );
    return response.data;
  };
...
export function changePassword({ token, password, newPassword }) {
  return async function () {
    ...
    const response = await axios.post(
      "https://experienceviveargentina.onrender.com/users/change_password",
...
export function softDelete({ token, userId }) {
  return async function () {
    ...
    const response = await axios.put(
      "https://experienceviveargentina.onrender.com/users/soft_delete",
      { userId },
      { headers }
    );
...
export function shiftAdmin({ token, userId }) {
  ...
  return async function () {
    ...
    const response = await axios.put(
      "https://experienceviveargentina.onrender.com/users/shift_admin_authorization",
      { userId },
      { headers }
    );
    console.log("response: " + response);
...
export function addPackageFavorite(packageId, userId) {
  return async function () {
    let response = await axios.post(
      `https://experienceviveargentina.onrender.com/favorites/packages?packageId=${packageId}&userId=${userId}`
    );
    console.log(response);
  };
}
...
export function addExperienceFavorite(experienceId, userId) {
  return async function () {
    let response = await axios.post(
      `https://experienceviveargentina.onrender.com/favorites/experiences?userId=${userId}&experienceId=${experienceId}`
    );
    console.log(response);
  };
}
...
export function removePackageFavorite(packageId, userId) {
  return async function () {
    let response = await axios.put(
      `https://experienceviveargentina.onrender.com/favorites/packages?userId=${userId}&packageId=${packageId}`
    );
    console.log(response);
  };
}
...
export function registerUser({ first_name, last_name, email, password }) {
  return async function () {
    await axios.post(
      "https://experienceviveargentina.onrender.com/users/singin",
      {
        email,
        password,
        first_name,
...
export function contactUs({ name, lastName, email, message }) {
  return async function () {
    ...
    await fetch(`https://experienceviveargentina.onrender.com/contactus/`, {
      method: "POST",
      headers: {
        Accept: "application/json",
        "Content-Type": "application/json",
...
export function getUserLogin({ email, password }) {
  return async function (dispatch) {
    let response = await axios.post(
      "https://experienceviveargentina.onrender.com/users/login",
      { email, password }
    );
...
export function googleLogin({ first_name, last_name, email, password, photo }) {
  return async function (dispatch) {
    ...
    const response = await axios.post(
      "https://experienceviveargentina.onrender.com/users/google_login",
...
export function getCitiesByName(cityName) {
  return async function (dispatch) {
    let citiesByName = await axios.get(
      `https://experienceviveargentina.onrender.com/cities?name=${cityName}`
    );
    return dispatch({
...
export function getCityById(cityId) {
  return async function (dispatch) {
    let cityById = await axios.get(
      `https://experienceviveargentina.onrender.com/cities/${cityId}`
    );
    return dispatch({
      type: GET_CITY_BY_ID,
...
export function getAllCities() {
  return async function (dispatch) {
    let allCities = await axios.get(
      `https://experienceviveargentina.onrender.com/cities`
    );
    return dispatch({
      type: GET_ALL_CITIES,
...
export function getAllPackages() {
  return async function (dispatch) {
    let allPackages = await axios.get(
      `https://experienceviveargentina.onrender.com/packages`
    );
    return dispatch({
...
export function getPackagesByName(packageName) {
  return async function (dispatch) {
    let packagesByName = await axios.get(
      `https://experienceviveargentina.onrender.com/packages?name=${packageName}`
    );
    return dispatch({
...
export function getPackageById(packageId) {
  return async function (dispatch) {
    let packageById = await axios.get(
      `https://experienceviveargentina.onrender.com/packages/${packageId}`
    );
    return dispatch({
...
export function getAllExperiences() {
  return async function (dispatch) {
    let allExperiences = await axios.get(
      `https://experienceviveargentina.onrender.com/experiences`
    );
    return dispatch({
...
export function getExperiencesByName(experienceName) {
  return async function (dispatch) {
    let experiencesByName = await axios.get(
      `https://experienceviveargentina.onrender.com/experiences?name=${experienceName}`
    );
    return dispatch({
...
export function getExperienceById(experienceId) {
  return async function (dispatch) {
    let experienceById = await axios.get(
      `https://experienceviveargentina.onrender.com/experiences/${experienceId}`
    );
    return dispatch({
...
export function getAllCategories() {
  return async function (dispatch) {
    let allCategories = await axios.get(
      `https://experienceviveargentina.onrender.com/categories`
    );
    return dispatch({
...
export function getCategoryById(categoryId) {
  return async function (dispatch) {
    let categoryById = await axios.get(
      `https://experienceviveargentina.onrender.com/categories/${categoryId}`
    );
    return dispatch({
...
export function getAllRegions() {
  return async function (dispatch) {
    let allRegions = await axios.get(
      `https://experienceviveargentina.onrender.com/regions`
    );
    return dispatch({
...
export function getRegionById(regionId) {
  return async function (dispatch) {
    let regionById = await axios.get(
      `https://experienceviveargentina.onrender.com/regions/${regionId}`
    );
    return dispatch({
...
export function updatePackage(newPackage, id) {
  ...
  return async function (dispatch) {
    let PackageUpdated = await axios.put(
      "https://experienceviveargentina.onrender.com/packages?packageId=" + id,
      newPackage
    );
  ...
  return async function (dispatch) {
    ...
    if (payload.categoryId && payload.packageId) {
      const result = await axios.get(
        `https://experienceviveargentina.onrender.com/categories/${payload.categoryId}`
      );
      ...
      const result = await axios.get(
        `https://experienceviveargentina.onrender.com/packages/${payload.packageId}`
      );
      filteredExperiences = result.data.experiences;
